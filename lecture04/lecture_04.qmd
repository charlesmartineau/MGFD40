...
5. **Testing Semi-Strong Form Market Efficiency**
   ...
   - No-News is News (Huberman & Regev), Merger Arbitrage
...
- Note: NPR (x-axis, in decile cut) stands for "Net Purchase Ratio" = (Insider Buys - Insider Sells) / Total Insider Trades
...
Akey et al., 2022 examine how private information illegally acquired through hacking is reflected in stock prices in an event study framework.
...
- [Barberis, Shleifer and Vishny (1998, JFE)](https://www.sciencedirect.com/science/article/pii/S0304405X98000270?casa_token=cGoe5ME3DekAAAAA:Du2NFJVKmKJ56CKe373SrkLasJyi3eM6_KX49XUaOAkJWTg-tbKtPmYvWcEDMQFvYjvSwyY2RUHI) suggest the conservatism bias (underreact to information): A “conservatism bias” can lead investors to underreact or underweight new information (related to anchoring bias). That's related to the "52-week high/low"analogy.
...
- Also, what if investors are bounded rational? In the no-news example of Huberman and Regev, one reason that can explain this is because we cannot process all the news. We are not mentally capable! We need event that captures our attention to price asset correctly.
