...
- Track the long-short returns over time

**Step 2:** Regress the long-short portfolio returns $R_{LS,t}$ on factor models
...
**CAPM (1 factor):**
$$R_{LS,t} = \beta_i (E(R_m) - R_f)$$

**Fama-French 3-Factor (1993):**
$$R_{LS,t} = \beta_{MKT}(R_m - R_f) + \beta_{SMB} \cdot SMB + \beta_{HML} \cdot HML$$
...
All factors are **long-short portfolios** themselves! There are more complicated factor models out there. 
